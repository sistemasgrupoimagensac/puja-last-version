        ...
        if ($request->caracteristicas) {
            ...
            try {
                $carac_inmueble = CaracteristicaInmueble::updateOrCreate([
                    ...
                    'habitaciones' => $request->habitaciones !== null ? (int)$request->habitaciones : null,
                    'banios' => $request->banios !== null ? (int)$request->banios : null,
                    'medio_banios' => $request->medio_banios !== null ? (int)$request->medio_banios : null,
                    'estacionamientos' => $request->estacionamientos !== null ? (int)$request->estacionamientos : null,
                    "area_construida" => $request->area_construida,
                    "area_total" => $request->area_total,
                    "antiguedad" => $request->antiguedad,
                    'anios_antiguedad' => $request->anios_antiguedad !== null ? (int)$request->anios_antiguedad : null,
