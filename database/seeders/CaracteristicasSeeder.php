...
class CaracteristicasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $caracteristicas = [
            ...
            ['categoria_caracteristica_id' => 1, 'caracteristica' => 'cancha de futbol',               'icono' => 'fa-futbol',               'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 1, 'caracteristica' => 'recepcion',                      'icono' => 'fa-bell-concierge',       'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 1, 'caracteristica' => 'television por cable',           'icono' => 'fa-tv',                   'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 1, 'caracteristica' => 'vista panoramica a la ciudad',   'icono' => 'fa-city',                 'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'almacen',                        'icono' => 'fa-warehouse',            'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'amoblado',                       'icono' => 'fa-couch',                'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'area de servicio',               'icono' => 'fa-user-gear',            'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'areas comunes',                  'icono' => 'fa-comments',             'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'ascensor(es)',                   'icono' => 'fa-elevator',             'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'balcon',                         'icono' => 'fa-house-chimney-window', 'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'calefaccion',                    'icono' => 'fa-fire',                 'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'habitacion de servicio',         'icono' => 'fa-screwdriver-wrench',   'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'habitacion principal con banio', 'icono' => 'fa-bath icon-orange',     'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'jacuzzi',                        'icono' => 'fa-water-ladder',         'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'jardin externo',                 'icono' => 'fa-sun-plant-wilt',       'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'jardin interno',                 'icono' => 'fa-plant-wilt',           'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'lavanderia',                     'icono' => 'fa-soap',                 'created_at' => now(), 'updated_at' => now()],
            ...
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'servicios basicos',              'icono' => 'fa-faucet-drip',          'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'tanque de agua',                 'icono' => 'fa-droplet',              'created_at' => now(), 'updated_at' => now()],
            ['categoria_caracteristica_id' => 2, 'caracteristica' => 'Terma electrica',                'icono' => 'fa-bolt',                 'created_at' => now(), 'updated_at' => now()],
