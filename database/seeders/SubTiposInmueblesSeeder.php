...
class SubTiposInmueblesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $property_subtype = [
            ...
            ['tipo_inmueble_id' => 2,'subtipo' => 'Departamento Flat', 'created_at' => now(), 'updated_at' => now()],
            ['tipo_inmueble_id' => 2,'subtipo' => 'Departamento Duplex', 'created_at' => now(), 'updated_at' => now()],
            ['tipo_inmueble_id' => 2,'subtipo' => 'Departamento Triplex', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['tipo_inmueble_id' => 4,'subtipo' => 'Terreno Industrial', 'created_at' => now(), 'updated_at' => now()],
