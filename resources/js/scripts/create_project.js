...
let modalInstance = null; // Instancia global del modal
let proyectoId = null; // ID del proyecto (global)

// Inicializar el modal y los botones de la interfaz cuando el DOM esté listo
...
document.getElementById('unidadForm').addEventListener('submit', function (event) {
    ...
    if (editIndex === null) {
        ...
        unidades[editIndex] = unidad; // Editar unidad existente
    }
...
window.proyectoId = proyectoId; // Asegurar que `proyectoId` sea globalmente accesible
