                            ...
                            <div class="plan-checkout-card">
                                <div class="card text-bg-dark shadow">
                                  <div class="card-body text-center d-flex flex-column justify-content-around">
                                    ...
                                    <p class="card-text h2"> avisos <small class="h5"> /  días </small> </p>
...
@props(['precio', 'userName', 'userSurname', 'userEmail', 'userPhone', 'userTypeId'])
