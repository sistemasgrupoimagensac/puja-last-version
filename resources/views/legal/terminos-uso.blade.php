    ...
    <div class="container my-5">
        <div class="terminos p-5">
            ...
            <p>
                ...
                exigencias de la moral y buenas costumbres. El Solicitante es el único y exclusivo responsable de mantener y
                proteger la confidencialidad de su Contraseña. En caso de pérdida, robo o vulneración en la seguridad del
                Nombre de Usuario y Contraseña, el Solicitante se compromete a comunicarlo a <strong>PUJA
                    INMOBILIARIA</strong> a la mayor brevedad posible, así como cualquier riesgo de acceso no autorizado por
                terceros.
            </p>
            ...
            <ol type="a">
                ...
                <li>Publicar ofertas que hagan mención de manera directa o indirecta a actividades
                    ilícitas o fraudulentas.
                </li>
                <li>Publicar avisos que no sean de venta y/o alquiler de inmuebles y/o que ofrezcan
                ...
                <li>Realizar la publicación de avisos (gratuitos o de costo) para el arrendamiento y/o
                    ...
                    de Uso y lesivos de los derechos e intereses de terceras personas.</li>
            ...
            <p>
                ...
                foros de discusión, entre otros— (en adelante, los “Canales”) de forma responsable,
                correcta, respetuosa y dando fiel cumplimiento a la normativa vigente.
                El contenido de cada mensaje enviado por el Solicitante a través de los Canales es de
                única y exclusiva responsabilidad del Solicitante. PUJA INMOBILIARIA no garantiza la
                veracidad ni exactitud de los datos personales y/o contenidos de cada mensaje
                efectuados y/o publicados en los Canales por el Solicitante. El Solicitante acepta
                voluntariamente que el acceso a y/o el uso de los Canales tiene lugar, en todo caso, bajo
                su exclusiva y única responsabilidad.
            </p>
			...
			<ol>
				...
				<li><span class="list-number" data-number="3.4.2."></span> Todo tipo de ataque personal contra usuarios del Sitio Web y/o terceros, incluyendo clientes de PUJA INMOBILIARIA, mediante acoso, amenazas, insultos;</li>
				<li><span class="list-number" data-number="3.4.3."></span> Todo acto contrario a las leyes, la moral y las buenas costumbres;</li>
				<li><span class="list-number" data-number="3.4.4."></span> Publicar mensajes, imágenes e hipervínculos agraviantes, difamatorios, calumniosos, injuriosos, falsos, discriminatorios, pornográficos, de contenido violento, insultantes, amenazantes, incitantes a conductas ilícitas o peligrosas para la salud, que lesionen el honor y/o que vulneren de cualquier forma la privacidad de cualquier tercero como así también la violación directa o indirecta de los derechos de propiedad intelectual de PUJA INMOBILIARIA y/o de cualquier tercero, incluyendo clientes de PUJA INMOBILIARIA;</li>
				<li><span class="list-number" data-number="3.4.5."></span> Publicar mensajes que puedan herir y/o afectar la sensibilidad del resto de los usuarios del Sitio Web y/o de cualquier tercero, incluyendo clientes de PUJA INMOBILIARIA;</li>
				<li><span class="list-number" data-number="3.4.6."></span> Promocionar, comercializar, vender, publicar y/u ofrecer cualquier clase de productos, servicios y/u actividades por intermedio de o a través de la utilización de los Canales, excepto aquellas expresamente permitidas por PUJA INMOBILIARIA;</li>
				<li><span class="list-number" data-number="3.4.7."></span> La venta, locación o cesión, ya sea a título oneroso o gratuito, del espacio de comunicación de los Canales;</li>
				<li><span class="list-number" data-number="3.4.8."></span> Publicar mensajes que de cualquier forma contengan publicidad;</li>
				<li><span class="list-number" data-number="3.4.9."></span> El uso o envío de virus informáticos, malware, spyware, ransomware y/o la realización de todo acto que cause o pudiera causar daños o perjuicios al normal funcionamiento de los Servicios y/o los Canales, o de los equipos informáticos o software de PUJA INMOBILIARIA y/o de cualquier tercero, incluyendo clientes de PUJA INMOBILIARIA;</li>
				<li><span class="list-number" data-number="3.4.10."></span> Todo acto dirigido a enmascarar y/o falsificar o disimular direcciones IP, correos electrónicos y/u otro tipo de paquete de datos, o cualquier parte de la información de la cabecera de cualquier correo electrónico o en mensajes de foros de debate;</li>
				<li><span class="list-number" data-number="3.4.11."></span> Todo acto que viole la privacidad de los usuarios del Sitio Web, o que viole cualquiera de sus derechos bajo la legislación en vigor en el país;</li>
				<li><span class="list-number" data-number="3.4.12."></span> La publicación de datos personales sin el consentimiento expreso del titular de los mismos;</li>
				<li><span class="list-number" data-number="3.4.13."></span> La transmisión o divulgación de material que viole la legislación en vigor en el país y/o que pudiera herir la sensibilidad de los usuarios del Sitio Web y/o de cualquier tercero, incluyendo clientes de PUJA INMOBILIARIA;</li>
				<li><span class="list-number" data-number="3.4.14."></span> La publicación de cualquier tipo de contenido en violación de derechos de terceros, incluyendo clientes de PUJA INMOBILIARIA, incluyendo sin limitación los derechos de propiedad intelectual y/o industrial.</li>
			</ol>

            <p>
                <strong>IMPORTANTE: PUJA INMOBILIARIA</strong> no tiene obligación de controlar ni controla la
                utilización que el Solicitante haga de los Canales ni del contenido de las publicaciones
                realizadas en los mismos y/o en los avisos del Sitio Web. No obstante, ello, <strong>PUJA INMOBILIARIA</strong> se reserva el derecho de no publicar o remover luego de ser publicados
                todos aquellos contenidos y/o mensajes propuestos y/o publicados por el Solicitante
                que, a exclusivo criterio de <strong>PUJA INMOBILIARIA</strong>, no respondan estrictamente a las
                disposiciones contenidas en estas Condiciones y/o resulten impropios y/o inadecuados
                a las características, finalidad y/o calidad de los Servicios.
            </p>
			...
			<p>
				<strong>PUJA INMOBILIARIA</strong> no es en ningún caso responsable de la destrucción, alteración o
				eliminación del contenido o información que cada Solicitante o usuario del Sitio Web
				incluya en sus mensajes.
			</p>

			<p>
				Cada Solicitante y usuario del Sitio Web es el único y exclusivo responsable de sus
manifestaciones, dichos, opiniones y todo acto que realice a través de los Canales.
			</p>
			...
			<p>
				...
				independiente de cualquier otra y la prestación de Servicios por parte de <strong>PUJA INMOBILIARIA</strong> no se deberá de interpretar en conjunto, sino en lo individual.
			</p>

			<p>
				Los Solicitantes podrán cancelar los Servicios que hubieren contratado en cualquier
				momento y a su entera discreción, debiendo dar previa notificación a <strong>PUJA INMOBILIARIA</strong>. Sin perjuicio de ello, no tendrán derecho a reembolso alguno de los
				Servicios contratados.
			</p>

			<ol>
				<li><span class="list-number" data-number="4.2.1."></span> Los Solicitantes deberán leer detenidamente los Servicios que incluye cada Plan, los términos de pago, y las demás condiciones de cada Plan, los cuales estarán descriptas en el Sitio Web.</li>
				<li><span class="list-number" data-number="4.2.2."></span> Cada Plan tendrá un plazo de publicación de 30 (treinta) o 90 (noventa) días corridos/naturales contados a partir de la acreditación del pago, o bien el plazo especificado para cada Plan.</li>
				<li><span class="list-number" data-number="4.2.3."></span> Vencido el referido plazo, y en caso de así detallarlo la descripción del Plan, el mismo se renovará en forma automática por igual plazo, salvo que el Solicitante lo cancele, bajo las condiciones detalladas en el punto 4 siguiente.</li>
				<li><span class="list-number" data-number="4.2.4."></span> El Solicitante podrá cancelar su Plan en cualquier momento, y continuará teniendo acceso al Plan hasta el final de su periodo de facturación. Los pagos no son reembolsables y no se otorgarán reembolsos ni créditos por los periodos del Plan utilizados parcialmente o por el servicio no utilizado. Si cancela el Plan, el mismo se dará de baja automáticamente al final de su periodo de facturación actual. Para cancelar el Plan, el Solicitante deberá ingresar a la sección “Contrataciones” en su panel de anunciante.</li>
				<li><span class="list-number" data-number="4.2.5."></span> El Plan será facturado al Solicitante por adelantado y conforme se encuentra especificado en la descripción de cada Plan. Para la activación del Plan contratado, se deberá acreditar el pago de la primera factura.</li>
				<li><span class="list-number" data-number="4.2.6."></span> El pago de la facturación se realizará por débito automático mediante las
					tarjetas de crédito autorizadas por <strong>PUJA INMOBILIARIA</strong></li>
			</ol>
			...
			<ol>
				<li><span class="list-number" data-number="8.1.1."></span> PUJA INMOBILIARIA no garantiza la utilidad de los Servicios para finalidades específicas.</li>
				<li><span class="list-number" data-number="8.1.2."></span> PUJA INMOBILIARIA no será responsable por las relaciones que como consecuencia del uso de los Servicios puedan entablarse entre los usuarios del Sitio Web y el Solicitante.</li>
				<li><span class="list-number" data-number="8.1.3."></span> PUJA INMOBILIARIA no será responsable por la veracidad de los datos y/o información, y/o la licitud de los contenidos que los usuarios o los Solicitantes ingresen al Sitio Web.</li>
				<li><span class="list-number" data-number="8.1.4."></span> PUJA INMOBILIARIA tampoco tiene la obligación de verificar la identidad ni la capacidad para contratar de los usuarios del Sitio Web, ni la veracidad, vigencia, y/u autenticidad de los datos que los usuarios proporcionen sobre sí mismos.</li>
				<li><span class="list-number" data-number="8.1.5."></span> PUJA INMOBILIARIA no garantiza ningún número mínimo de visitas por parte de Usuarios a los anuncios que publique el Solicitante en los Sitios Webs, por lo que el Solicitante excluye toda responsabilidad de PUJAINMOBILIARIA por los daños y perjuicios de toda naturaleza que pudiera sufrir como consecuencia de la ausencia de visitas de Usuarios.</li>
				<li><span class="list-number" data-number="8.1.6."></span> PUJA INMOBILIARIA podrá replicar el contenido de los anuncios que publique el Solicitante en los Sitios Web.</li>
				<li><span class="list-number" data-number="8.1.7."></span> PUJA INMOBILIARIA no es responsable en ningún caso por el mal uso que le den los Solicitantes anunciantes al Sitio Web mediante la publicación de avisos clasificados que sean o resulten engañosos, fraudulentos, incompletos, falsos o inexactos.</li>
				<li><span class="list-number" data-number="8.1.8."></span> Cualquier Solicitante que utiliza el Sitio Web y contrata los Servicios, lo hace asumiendo todos los riesgos que ello implica. PUJA INMOBILIARIA en ningún caso garantiza que: (i) los Solicitantes anunciantes sean quien ostentan ser; (ii) los derechos o interés jurídico que los Solicitantes anunciantes tengan, o bien no tengan, sobre los inmuebles anunciados; (iii) los precios de venta o renta de los inmuebles anunciados, en cualquier modalidad, en nuestra plataforma, y tampoco asume obligación alguna de verificar dicha información.</li>
				<li><span class="list-number" data-number="8.1.9."></span> PUJA INMOBILIARIA, sus directivos, empleados, accionistas o asesores, en ningún caso crean, realizan, o redactan el anuncio que publican los Solicitantes anunciantes.</li>
				<li><span class="list-number" data-number="8.1.10."></span> PUJA INMOBILIARIA niega expresamente cualquier garantía de comerciabilidad, calidad satisfactoria, idoneidad para un fin determinado, uso y disfrute pacífico o no infracción, así como cualquier garantía expresa o implícita.</li>
			</ol>

			<h5 class="terminos-articulo">8.2 El Solicitante declara y garantiza que:</h5>

			<ol>
				<li><span class="list-number" data-number="8.2.1."></span> El uso de los Servicios se lleva a cabo bajo su única y exclusiva responsabilidad y riesgo comercial.</li>
				<li><span class="list-number" data-number="8.2.2."></span> Utilizará los Servicios en un todo de acuerdo a estas Condiciones, las Condiciones Generales de Uso, la normativa vigente y demás leyes, decretos, resoluciones, disposiciones y decisiones gubernamentales que en el futuro se dicten y resulten aplicables.</li>
				<li><span class="list-number" data-number="8.2.3."></span> Cuenta con plenas facultades para aceptar estas Condiciones y cumplir con todas las obligaciones emergentes de la prestación de los Servicios.</li>
				<li><span class="list-number" data-number="8.2.4."></span> Ningún integrante del personal del Solicitante actuará ni realizará declaración alguna ni actuará de modo tal que razonablemente pueda dar lugar a un daño para PUJA INMOBILIARIA, inclusive un perjuicio a su reputación. El Solicitante será responsable por las acciones de las personas que utilicen su cuenta y el Servicio en su nombre y/o que estén en relación de dependencia y/o contratadas y/o vinculadas.</li>
				<li><span class="list-number" data-number="8.2.5."></span> El Solicitante indemnizará y mantendrá indemne a PUJA INMOBILIARIA por los reclamos y las pérdidas sufridas como resultado de cualquier violación a cualquier garantía estipulada en la presente cláusula y en las Condiciones y/o por cualquier reclamo relacionado al uso del Servicio y/o formulado por sus dependientes y/o terceros.</li>
			</ol>
...
etc
			...
			<p>
				12.2. El incumplimiento por el Solicitante a cualquiera de las obligaciones a su cargo
consignadas en las presentes Condiciones, en las Condiciones Generales de Uso o en las
condiciones particulares que pudieran aplicar a cada Servicio, facultará a <strong>PUJA INMOBILIARIA</strong> a: (a) tener por resuelto el presente automáticamente y de pleno
derecho y sin deber de preaviso o indemnización al Solicitante; y/o (b) exigir el
cumplimiento de la prestación debida, en ambos casos con más la indemnización de los
daños y perjuicios ocasionados.
			</p>
...
directivos o accionistas, ni que alguna de las partes tiene poder para representar a la
otra.
			...
			<p>
				El Solicitante acepta defender, indemnizar y sacar en paz y a salvo a <strong>PUJA INMOBILIARIA</strong> y a sus filiales y subsidiarias, y a sus respectivos consejeros, directivos,
...
vigencia y efecto.
			...
			<p>
				16.2. <strong>PUJA INMOBILIARIA</strong> se reserva el derecho a modificar total o parcialmente estas
Condiciones en cualquier momento, en cuyo caso las Condiciones actualizadas se
publicarán en el Sitio Web, siendo obligación de los Solicitantes revisar regularmente
esta sección a fin de informarse de cualquier cambio que se pueda haber producido. El
Solicitante acepta que la mera publicación de las Condiciones actualizadas por parte de
<strong>PUJA INMOBILIARIA</strong> tendrá plena validez como notificación suficiente. Sin perjuicio
de ello, en caso de llevar a cabo alguna modificación, <strong>PUJA INMOBILIARIA</strong> podrá
notificar al Solicitante a la dirección de correo electrónico registrada para utilizar el Sitio
Web y los Servicios. El Solicitante acepta que la notificación por parte de <strong>PUJA INMOBILIARIA</strong> a dicha dirección de correo electrónico tendrá plena validez como
notificación suficiente. Asimismo, si el Solicitante persiste en la utilización de los
Servicios y/o el Sitio Web, se considerará que ha aceptado implícitamente las nuevas
Condiciones.
			...
			<p>
				17.1.2. El Sitio Web es <a class="footer-link-puja" href="/" target="blank"> www.pujainmobiliaria.com.pe</a>.
			</p>

			<p>
				17.1.3. Los Servicios son: La subasta de inmuebles que fueron hipotecados, rematando
a precios por debajo del mercado, en los sitios <a class="footer-link-puja" href="/" target="blank"> www.pujainmobiliaria.com.pe</a>.
			</p>
...
web:  <a class="footer-link-puja" href="/" target="blank"> http://www.bcrp.gob.pe/</a>
